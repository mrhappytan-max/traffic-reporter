...
**Status: on branch `feature/v1.8.7.0-dynamic-shoulder-single-cctv`, branched from main (V1.8.6.9a), NOT merged, NOT deployed.** See `PROJECT_HANDOFF.md` §27 for the full design writeup.
