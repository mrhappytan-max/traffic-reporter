...
// V2.3.0/V2.3.1/V2.3.2/V2.3.3/V2.4.0/V2.4.1/V2.4.2/V2.4.3/V2.4.4 only bump
// the literal), same discipline test/versionLineage.test.js's own
// series-prefix check already follows.
test('12: APP_VERSION reflects the current release', () => {
  assert.equal(APP_VERSION, 'V2.4.4');
});
