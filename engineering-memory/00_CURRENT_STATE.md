...
| Current Version | V2.4.16（唯一權威來源：`src/version.js` 的 `APP_VERSION`；2026-09-07 路況-040：`resolveCctvEligibility()` 移除 `event.type === 'accident'` 職責錯置檢查，改為「AI 判定通報即給圖」，PATCH bump，詳見07_KNOWN_ISSUES_03.md） |
