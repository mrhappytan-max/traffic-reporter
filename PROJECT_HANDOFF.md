...
## 31. V1.8.7.3 — CCTV Prepare-Timeout Fix + Pipeline Trace Filter Fix

**Status: on branch `fix/v1.8.7.3-cctv-timeout-trace-filter`, branched from latest `main` (which already includes V57.3). NOT merged, NOT deployed.**
