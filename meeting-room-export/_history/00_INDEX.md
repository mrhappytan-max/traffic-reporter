...
| `PROJECT_HANDOFF_08of08.md` | 42711 | 35. V1.8.7.7 — CCTV Gray Broken Image Fix (Dynamic-Shoulder Frame Truncation)；36. Meeting Room Engineering Memory v1；37. Google Drive Connector Direct Sync V1 — permanent Agent Rule；38. V1.1 — DELTA SYNC is the default; FULL VERIFY is exception-only；39. TDX 額度用盡 — 暫時 PBS-ONLY MODE（2026-08-23） |
